...
public class IslandoraFcrepoIndexerUnmapBinaryRdfTests extends FcrepoIndexerTestFramework {

    private final static String routeName = "IslandoraFcrepoIndexerUnmapBinaryRdf";
    ...
    public void testUnmapBinaryRdfRoutesToResultOnSuccess() throws Exception {
        ...
        sendBodyAndHeaders("delete-binary-event.json", h("Authorization", "some_nifty_token"),
                h("DrupalRdfPath", "sites/default/files/foo.jpeg"));
