 ...
 *
 */
public class IslandoraFcrepoIndexerUpdateBinaryMapRdfTests extends FcrepoIndexerTestFramework {

    private final static String routeName = "IslandoraFcrepoIndexerUpdateBinaryMapRdf";
