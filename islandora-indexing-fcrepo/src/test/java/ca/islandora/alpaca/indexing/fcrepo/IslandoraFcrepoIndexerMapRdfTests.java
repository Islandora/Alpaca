...
public class IslandoraFcrepoIndexerMapRdfTests extends FcrepoIndexerTestFramework {

    private final static String routeName = "IslandoraFcrepoIndexerMapRdf";
    ...
    public void testMapRoutesToResultOnSuccess() throws Exception {
        ...
        sendBodyAndHeaders("create-event.json", h("Authorization", "some_nifty_token"),
                h("DrupalRdfPath", "fedora_resource/1"), h("FcrepoRdfPath", "foo"));
