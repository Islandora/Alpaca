 ...
 *
 */
public class IslandoraFcrepoIndexerUpdateRdfTests extends FcrepoIndexerTestFramework {

    private final static String routeName = "IslandoraFcrepoIndexerUpdateRdf";
